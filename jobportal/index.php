  ...
  <!--Corsule -->
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="img/vikh.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Vikhyat Singh</h2>
        </div>
        <div class="col-lg-4">
          <img class="img-circle" src="img/chet.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Chetna Grover</h2>
        </div>
      </div><!-- /.row -->
